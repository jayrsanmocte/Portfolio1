     ...
     <div className="container padder">
       ...
       <div className="row">
         ...
         <div className="card " data-aos="zoom-in">
           <div className="scrollable-image">
             <div className="image-overlay"></div>
             <img className="card-img-top" src="/Images/plumbing.png" alt="Title" />
           </div>
         </div>
         <div className="col md-12 sm-6">
           <ul>
             <div className="description" data-aos="zoom-in-left">Project</div>
             <li className='description2' data-aos="zoom-in-left">Plumbing Service Website</li>
           </ul>
          
          <div className="line2 md-12"> <h5 className='description3 text-center pt-3' data-aos="fade-left">Our plumbing service, powered by the dynamic duo of <span style={{ color: '#64fedb' }}>React JS and Bootstrap</span>. Discover a world of efficient plumbing solutions tailored to your needs, much like selecting the perfect companion for your home:</h5> </div>
            <div className="row">
             <div className="col ">
